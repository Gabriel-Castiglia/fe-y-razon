/**
 * Diccionario de traducciones: LATINA
 * Latina ecclesiastica — Versio Vulgata pro locis Scripturae adhibita.
 */
...
const translationsLA = {
  ...
  hero: {
    eyebrow: "Salve",
    title: "Disce et defende<br>fidem tuam <em>catholicam</em>",
    desc: "Argumenta apologetica solida ad intelligendum, vivendum et communicandum fidem catholicam cum persuasione et sapientia.",
    btn1: "Articulos legere",
    btn2: "Nostra missio"
  },
  topics: {
  ...
  article1: {
    ...
    date: "Maio MMXXVI",
    title: "Sacerdotium",
    excerpt: "Munus sacerdotii ordinati in Ecclesia catholica eiusque momentum in vita sacramentali.",
    time: "XI min lectura",
    link: "Lege →"
  },
  article2: {
    ...
    date: "Maio MMXXVI",
    title: "Cur credimus",
    excerpt: "Rationes fundamentales credendi fidem catholicam eiusque cohaerentia cum ratione humana.",
    time: "XV min lectura",
    link: "Lege →"
  },
  article3: {
    ...
    date: "Maio MMXXVI",
    title: "Eucharistia",
    excerpt: "Sacramentum centrale Ecclesiae catholicae eiusque significatio in vita christiana.",
    time: "XIII min lectura",
    link: "Lege →"
  },
  article4: {
    category: "Doctrina",
  ...
  article10: {
    category: "Subsidia",
    date: "Maio MMXXVI",
    title: "Subsidia Commendanda",
    excerpt: "Electio subsidiorum catholicorum ad fidem et formationem approfundandam.",
    time: "V min lectura",
    link: "Explora →"
  },
  mission: {
    ...
    illuminate: {
      title: "Illuminare",
      desc: "Responsiones claras praebere quae fidelibus adiumento sint ad fidem melius intelligendam et ad difficiles quaestiones respondendum."
    },
    defend: {
      title: "Defendere",
      desc: "Argumenta apologetica offerre ad intelligendum et defendendam fidem catholicam adversus obiectiones, dubia et omnia genera haeresium modernarum."
    }
  },
  contact: {
    title: "Contactus",
    desc: "Habesne quaestiones vel nobiscum collaborare vis? Nuntium nobis mitte.",
    name: { placeholder: "Nomen tuum" },
    email: { placeholder: "Inscriptio electronica tua" },
  ...
  topicPages: {
    common: {
      prevLabel: "Articulus prior",
      nextLabel: "Articulus sequens",
      backToTopics: "Ad Themata reverti"
    },
    "el-purgatorio": {
      pageTitle: "Purgatorium | Fides et Ratio",
    ...
    "la-eucaristia": {
      pageTitle: "Eucharistia | Fides et Ratio",
      hero: `<div class="hero-eyebrow">
                <span class="eyebrow-line"></span>
                <span class="eyebrow-text">Thema Speciale</span>
            </div>
            <h1>Eucharistia: Sacramentum centrale</h1>
            <p>Estne Eucharistia symbolum an verum Corpus Christi? Ioannes VI, Paulus et primi christiani eandem responsionem dant.</p>
            <div class="article-meta">
    ...
    "la-nueva-ley": {
      pageTitle: "Nova Lex | Fides et Ratio",
      hero: `<div class="hero-eyebrow">
                <span class="eyebrow-line"></span>
                <span class="eyebrow-text">Thema Speciale</span>
            </div>
    ...
    "la-primacia-de-pedro": {
      pageTitle: "Primatus Petri | Fides et Ratio",
      hero: `<div class="hero-eyebrow">
                <span class="eyebrow-line"></span>
                <span class="eyebrow-text">Thema Speciale</span>
            </div>
    ...
    "la-santisima-trinidad": {
      pageTitle: "Sanctissima Trinitas | Fides et Ratio",
      hero: `<div class="hero-eyebrow">
                <span class="eyebrow-line"></span>
                <span class="eyebrow-text">Thema Speciale</span>
            </div>
    ...
    "los-santos": {
      pageTitle: "Sancti | Fides et Ratio",
      hero: `<div class="hero-eyebrow">
                <span class="eyebrow-line"></span>
                <span class="eyebrow-text">Thema Speciale</span>
            </div>
    ...
    "por-que-creemos": {
      pageTitle: "Cur credimus | Fides et Ratio",
      hero: `<div class="hero-eyebrow">
                <span class="eyebrow-line"></span>
                <span class="eyebrow-text">Thema Speciale</span>
            </div>
    ...
    "sacerdocio": {
      pageTitle: "Sacerdotium | Fides et Ratio",
      hero: `<div class="hero-eyebrow">
                <span class="eyebrow-line"></span>
                <span class="eyebrow-text">Thema Speciale</span>
            </div>
    ...
    "transubstanciacion": {
      pageTitle: "Transsubstantiatio | Fides et Ratio",
      hero: `<div class="hero-eyebrow">
                <span class="eyebrow-line"></span>
                <span class="eyebrow-text">Thema Speciale</span>
            </div>
    ...
    "recursos-recomendados": {
      ...
      hero: `<div class="hero-eyebrow">
                <span class="eyebrow-line"></span>
                <span class="eyebrow-text">Subsidia</span>
            </div>
