const translationsFR = {
  ...
  hero: {
    eyebrow: "Bienvenue",
    title: "Apprenez et défendez<br>votre <em>foi catholique</em>",
    desc: "Des arguments apologétiques solides pour comprendre, vivre et partager la foi catholique avec conviction et sagesse.",
    btn1: "Explorer les articles",
    btn2: "Notre mission"
  },
  topics: {
  ...
  article2: {
    category: "Apologétique", date: "Mai 2026", title: "Pourquoi nous croyons", excerpt: "Les raisons fondamentales de croire en la foi catholique et sa cohérence avec la raison humaine.", time: "15 min de lecture", link: "Lire →"
  },
  article3: {
  ...
  contact: {
    ...
    errors: {
      email: "L’adresse e-mail semble incomplète : vérifiez qu’il ne manque pas la fin, comme « .com ».",
      send: "Le message n’a pas pu être envoyé. Réessayez dans quelques minutes.",
      offline: "Pas de connexion au serveur. Vérifiez votre connexion internet et réessayez."
    },
    success: { title: "Message reçu", desc: "Merci de nous avoir écrit. Nous vous répondrons dans les plus brefs délais. Ad majorem Dei gloriam.", back: "Écrire un autre message" }
  },
  topicPages: {
...
Nous donc aussi, <strong class="s-hi">entourés que nous sommes d'une si grande nuée de témoins,</strong> nous devons, nous débarrassant de tout fardeau et du péché qui nous enveloppe, courir avec endurance l'épreuve qui nous est proposée, les yeux fixés sur Jésus, qui est l'auteur et le consommateur de la foi ; lequel, en vue de la joie qui lui était proposée, a souffert la croix, au mépris de la honte, et s'est assis à la droite du trône de Dieu. Pensez à celui qui a supporté de la part des pécheurs une telle hostilité, afin <strong class="s-hi">que vous ne vous lassiez pas et que vous ne vous découragiez pas dans vos âmes. »</strong></blockquote>
  ...
  meditacion: {
    quotes: [
      { ref: "Jean 14, 6", text: "Je suis le Chemin, la Vérité et la Vie." },
